-- Migration: v2_fact_review_conflict_preview_rpc
-- Authored: 2026-05-27
--
-- Purpose:
--   Extend the pending fact review read-model RPC with a read-only conflict
--   preview. This warns when a pending fact has the same entity/type/key as an
--   approved fact but a different value. It does not supersede or mutate canon.
--
-- Scope:
